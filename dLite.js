// Developed by Robert Nyman, code/licensing: http://code.google.com/p/dlite/, documentation: http://www.robertnyman.com/dlite, version 1.0
var dLite = function () {
	return {
		init : function () {
			if (!window.elm) {
			...
			if (!window.elmsByClass) {
				if (document.getElementsByClassName) {
					window.elmsByClass = function (className, tag, elm) {
						elm = elm || document;
